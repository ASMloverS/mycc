...
impl Diagnostic {
    ...
    pub fn new_with_source(
        ...
        let mut diag = Self::new(file, line, col, severity, rule_id, message);
        diag.source_line = Some(source.to_string());
        diag
    }
}
...
mod tests {
    ...
    fn display_format() {
        ...
        assert_eq!(
            format!("{d}"),
            "main.py:10:5: warning: function should use snake_case [naming-function]"
        );
    }
}
