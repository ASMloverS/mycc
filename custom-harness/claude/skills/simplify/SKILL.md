---
name: simplify
description: Review recent code changes for reuse, quality, and efficiency, then fix the issues found. Launches three focused reviewer subagents in parallel (reuse / quality / efficiency), passes each the full diff, aggregates findings, and applies fixes directly. Use after writing or editing code to clean it up — trigger when the user asks to simplify, clean up, polish, refactor for readability, or review recent edits.
