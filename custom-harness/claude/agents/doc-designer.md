---
name: doc-designer
description: Generates design docs from context/references, splits into task docs
  with index. Use when planning new features, modules, or subsystems. Supports --no-split,
  --en/--cn flags.
