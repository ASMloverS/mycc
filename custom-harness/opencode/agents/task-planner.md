---
description: 'Plans implementation tasks by scanning codebase, finding reusable utilities,
  and producing structured plans. Use before writing code. Input: task description.
  Output: plan JSON or UNCLEAR question.'
mode: subagent
