---
description: 'Implements code via TDD red-green cycle. Writes failing test first,
  then minimal implementation. Input: plan JSON from task-planner. Output: impl files
  + test files.'
mode: subagent
