---
description: 'Writes structured bug documentation to docs/bugs/ in Chinese. Use after
  a bug has been successfully fixed. Input: root cause, fix summary, related files,
  severity, test paths. Output: bug doc path.'
mode: subagent
